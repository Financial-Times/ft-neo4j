...
if [ "$1" == "neo4j" ]; then
    ...
    echo "dbms.querylog.enabled=true">>conf/neo4j.properties
    echo "dbms.querylog.parameter_logging_enabled=true">>conf/neo4j.properties
    echo "dbms.querylog.filename=/dev/stdout">>conf/neo4j.properties
